...
/* package rubik-solver-0.1.0.0 */
#ifndef VERSION_rubik_solver
#define VERSION_rubik_solver "0.1.0.0"
#endif /* VERSION_rubik_solver */
#ifndef MIN_VERSION_rubik_solver
#define MIN_VERSION_rubik_solver(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_rubik_solver */
...
#define CURRENT_COMPONENT_ID "rubik-solver-0.1.0.0-inplace-rubik-solver"
